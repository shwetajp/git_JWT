...
app.post("/register", async (req, res) => {
  ...
  try {
    ...
    // Save user data
    users.push({ username, password: hashedPassword }); // Make sure to save hashed password
    console.log(users);
...
//     newRecipe.id = Date.now(); // Generate a unique ID for the new recipe
//     newRecipe.userId = req.user.username; // Add user ID to the new recipe
